...
namespace StudentDataAccessLayer
{
    ...
    {
        //static string _connectionString = "Server=localhost;Database=Students;User Id=sa;Password=sa123456;Encrypt=False;TrustServerCertificate=True;Connection Timeout=30;";
        ...
        {
            using (var connection = new SqlConnection(clsDataSettings._connectionString))
